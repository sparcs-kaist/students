...
/**
 * @version v0.1
 * @description 각 매니저 권한으로 예산안(수입) Revision을 조회합니다.
 */

const url = () => `/manager/proposals/budget-proposals/income-revision/read`;
const method = "GET";
export const ApiPrp010RequestUrl =
  "/manager/proposals/budget-proposals/income-revision/read";
