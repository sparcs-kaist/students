...
import { ProjectReportDetailTotalReview } from "@sparcs-students/web/features/document-lookup/project/type/managerFormValues";
...
interface MemberTableProps {
  data: ProjectReportDetailTotalReview[];
}

const columnHelper = createColumnHelper<ProjectReportDetailTotalReview>();
...
const ManagerProjectReportReviewTable: React.FC<MemberTableProps> = ({
  data,
}) => {
...
export default ManagerProjectReportReviewTable;
