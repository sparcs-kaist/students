...
export const BudgetReviewThreeInputMock: ThreeInputItem[] = [
  {
    id: 0,
    label: "2024년도",
    year: 2024,
    value: {
      ...
      documentType: {
        types: [
          DocumentType.PreExecution,
          DocumentType.AdditionalRevision,
          DocumentType.PostApproval,
        ],
        selectedType: DocumentType.PreExecution,
        organization: [
          {
            key: { label: "어떤 집단 1", value: "어떤 집단 1" },
            values: [
  ...
  },
  {
    ...
    value: {
      ...
      documentType: {
        ...
        selectedType: DocumentType.AdditionalRevision,
        organization: [
          {
            key: { label: "어떤 집단 3", value: "어떤 집단 3" },
            values: [
  ...
  },
  {
    ...
    value: {
      ...
      documentType: {
        ...
        selectedType: DocumentType.PostApproval,
        organization: [
          {
            key: { label: "어떤 집단 5", value: "어떤 집단 5" },
            values: [
