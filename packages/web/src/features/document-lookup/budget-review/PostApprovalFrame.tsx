...
import { dataToBudgetReviewTotal } from "./util/dataToBudgetReviewTotal";
    ...
    <FlexWrapper direction="column" gap={48}>
      <FlexWrapper direction="column" gap={60} style={{ padding: "20 0px" }}>
        ...
        <BudgetReviewTotalTable
          isPostApproval
          data={dataToBudgetReviewTotal(formMethods.getValues("expenditures"))}
        />
        <ButtonWrapper>
...
export default PostApprovalFrame;
