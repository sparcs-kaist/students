...
export const ProjectProposalRevision = mysqlTable(
  ...
  table => ({
    ...
    // projectProposalRevisionAgendaIdFk: foreignKey({
    //   columns: [table.agendaId],
    //   foreignColumns: [Agenda.id],
    //   name: "project_proposal_revision_agenda_id_fk",
    // }),
  }),
);
...
export const OperationProposal = mysqlTable(
  ...
  table => ({
    ...
    operationProposalOrganizationDiagramIdFk: foreignKey({
      columns: [table.organizationDiagramId],
      foreignColumns: [File.id],
      name: "operation_proposal_organization_diagram_id_fk",
    }),
  }),
);
